...
cv<-read.csv("ADMIXTURE/logout_all_results_mac1_92ind_Q1000_GQ20_DP8_autosomes_miss0.75_HetHom_minMQ30_LD_prune0.5_w134.cv.error",header=F,sep=" " )
colnames(cv)<-c("K","CV")
...
name <- read.table("ADMIXTURE/logout_all_results_mac1_92ind_Q1000_GQ20_DP8_autosomes_miss0.75_HetHom_minMQ30_LD_prune0.5_w134.list")
tbl2=read.table("ADMIXTURE/all_results_mac1_92ind_Q1000_GQ20_DP8_autosomes_miss0.75_HetHom_minMQ30_LD_prune0.5_w134.2.Q")
...
tbl3=read.table("ADMIXTURE/all_results_mac1_92ind_Q1000_GQ20_DP8_autosomes_miss0.75_HetHom_minMQ30_LD_prune0.5_w134.3.Q")
...
tbl4=read.table("ADMIXTURE/all_results_mac1_92ind_Q1000_GQ20_DP8_autosomes_miss0.75_HetHom_minMQ30_LD_prune0.5_w134.4.Q")
...
tbl5=read.table("ADMIXTURE/all_results_mac1_92ind_Q1000_GQ20_DP8_autosomes_miss0.75_HetHom_minMQ30_LD_prune0.5_w134.5.Q")
...
tbl6=read.table("ADMIXTURE/all_results_mac1_92ind_Q1000_GQ20_DP8_autosomes_miss0.75_HetHom_minMQ30_LD_prune0.5_w134.6.Q")
