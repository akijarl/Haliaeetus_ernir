...
hist(Main_Isl,main="Island - Mainland divergence",xlab="Year of divergence",xlim = c(2000,16000), ylim = c(0,5))
hist(Main_Gre,main="Greenland - Mainland divergence",xlab="Year of divergence",xlim = c(2000,16000), ylim = c(0,5))
hist(Main_Ice,main="Iceland - Mainland divergence",xlab="Year of divergence",xlim = c(2000,16000), ylim = c(0,5))
